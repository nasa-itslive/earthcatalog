...
# ``geoarrow.wkb`` Arrow extension type when writing GeoParquet.
...
schema = pa.schema(
    [
        ...
        ),  # WKB; optional (rustac writes as nullable)
        # Timestamps
        ...
        pa.field("percent_valid_pixels", pa.int64(), nullable=True),
        pa.field("date_dt", pa.int64(), nullable=True),
        # Coordinates
        ...
        pa.field("proj_code", pa.string(), nullable=True),
        pa.field("sat_orbit_state", pa.string(), nullable=True),
        ...
        # STAC top-level fields — JSON serialized for schema flexibility
