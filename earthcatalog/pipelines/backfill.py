...
def _write_parquet_to_store(batch: list[dict], store: object, key: str) -> int:
    ...
    Writes to a temporary file via :func:`~earthcatalog.transform.write_geoparquet`,
...
def _update_hash_index_from_parquets(
    ...
    :mod:`earthcatalog.store_config` — this path is deprecated.
    """
    from obstore.store import LocalStore

    from earthcatalog.hash_index import merge_hashes_from_parquets, read_hashes, write_hashes
