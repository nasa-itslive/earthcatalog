...
# FROZEN BASELINE — do not modify.  Verbatim copy of
# ``earthcatalog/consolidate.py`` at commit c242d18 (the implementation that
# timed out in run 35512276524), with only the relative import rewritten.
# The benchmark imports this module as the "before" side of the comparison.
